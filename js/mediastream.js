			var signalling_server_hostname = location.hostname || "192.168.0.152";
			var signalling_server_address = signalling_server_hostname + ':' + (8080 || 80); //location.port -> 8080

			addEventListener("DOMContentLoaded", function() {
				document.getElementById('signalling_server2').value = signalling_server_address;
			});
			...
			function start() {
				if ("WebSocket" in window) {
					...
					server = document.getElementById("signalling_server2").value.toLowerCase();
